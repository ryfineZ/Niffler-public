...
use crate::ai_serving::{
    resolve_gemini_stream_spec as resolve_surface_stream_spec,
    resolve_gemini_sync_spec as resolve_surface_sync_spec,
};
...
pub(crate) use crate::ai_serving::normalize_gemini_request_to_openai_chat_request;
